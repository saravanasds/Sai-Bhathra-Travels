...
const AboutTravels = () => {
  ...
  return (
    <div className="w-full lg:py-20 py-10 px-2 xxs:px-4 sm:px-10 bg-gradient-to-t from-white via-[#d5f7ff] to-white">
      {/* Section Title */}
      <h2
        className="text-2xl sm:text-4xl font-bold text-center text-secondary pb-8 sm:pb-10 uppercase tracking-wider"
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left font-bitter" data-aos="fade-left">
          ...
          <div className="mt-8">
            <a
              ...
              className="inline-block bg-secondary text-white tracking-wider text-sm sm:text-base lg:text-lg px-8 py-3 sm:px-10 sm:py-4 rounded-xl shadow-sm shadow-gray-800 hover:bg-secondary hover:text-white transition-all duration-300 ease-in-out transform   hover:scale-105 font-bold"
            >
              Contact Us
            </a>
          </div>
